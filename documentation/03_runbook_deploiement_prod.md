...
## 8. Preuves a conserver pour la remise ECF

- URL publique de l'application
- Date/heure du deploiement
- Capture smoke test (`scripts/smoke_test_http.sh`)
- Identifiants de demonstration (au moins un admin)
